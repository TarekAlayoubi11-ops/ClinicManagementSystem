...
A 3-layer backend application (DAL, BLL, API) built with C# and SQL Server for managing school operations. The project demonstrates layered architecture, clean code practices, and robust business logic.

Features

Manage Doctors, Invoices, Appointments, and Patients
